/**
 * ==========================================================================
 * ADHYAYN LIBRARY - SEAT MANAGEMENT MODULE
 * ==========================================================================
 *
 ...
 *
 * IMPORTANT:
 * - Uses current Adhyayn Library Firestore structure
 * - Works only inside current admin library session
 * - Does NOT use LibManageDB
 * - Does NOT load another library's data
 * - Includes Morning / Afternoon / Evening / Full Day
 * ==========================================================================
 */
...
/* ==========================================================================
   4. CURRENT ADHYAYN FIRESTORE LIBRARY REFERENCE
   ========================================================================== */
...
function getSeatLibraryRef() {
    ...
    /*
     * Use the existing Adhyayn dashboard helper
     * when available.
     */
    ...
    /*
     * Fallback to direct Firestore reference.
     */
...
async function loadSeatCapacity() {
    ...
    try {
        ...
        console.error(
            "[Adhyayn Seats] Capacity loading error:",
            error
        );
...
async function saveSeatCapacity(
    ...
    if (
        ...
        alert(
            "Please enter a valid full day capacity."
        );
    ...
    if (
        ...
        alert(
            "Morning + Afternoon + Evening + Full Day capacity cannot be greater than total library capacity."
        );
    ...
    try {
        ...
        /*
         * Automatically create missing seat documents.
        ...
        console.error(
            "[Adhyayn Seats] Capacity save error:",
            error
        );
...
async function loadSeatStudents() {
    ...
    try {
        ...
        console.error(
            "[Adhyayn Seats] Student loading error:",
            error
        );
...
/* ==========================================================================
   16. GET OCCUPIED / AVAILABLE TOTAL
   ========================================================================== */
...
/* ==========================================================================
   19. SHIFT NAME NORMALIZER
   ========================================================================== */

function normalizeSeatShift(
    shift
) {
...
function startSeatStudentListener() {
    ...
    if (!studentsRef) {
        ...
        console.error(
            "[Adhyayn Seats] Student database reference unavailable."
        );
    ...
    seatsStudentUnsubscribe =
        studentsRef.onSnapshot(
            ...
            (error) => {
                ...
                console.error(
                    "[Adhyayn Seats] Realtime student listener error:",
                    error
                );
    ...
    seatsCapacityUnsubscribe =
        capacityRef.onSnapshot(
            ...
            (error) => {
                ...
                console.error(
                    "[Adhyayn Seats] Capacity realtime listener error:",
                    error
                );
...
async function initializeSeatsModule() {
    ...
    if (
        ...
        console.error(
            "[Adhyayn Seats] Firebase SDK not loaded."
        );
    ...
    if (
        ...
        console.error(
            "[Adhyayn Seats] Firestore instance unavailable."
        );
    ...
    console.log(
        "[Adhyayn] Seat Management module loaded."
    );
